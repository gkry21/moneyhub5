...
auth_vue = {
      ...
      join_body : ()=>{
            return '<link rel="stylesheet" type="text/css"  href="https://getbootstrap.com/docs/4.3/examples/checkout/form-validation.css">'+
        '<style>'+
        '.bd-placeholder-img {'+
              'font-size: 1.125rem;'+
              'text-anchor: middle;'+
      ...
      login_body : x=>{
            ...
            '    <input type="email" id="aid" class="form-control" placeholder="Email address" required="" autofocus="">'+
    ...
    mypage_body : x=>{
          ...
          '    <label for="aid" class="sr-only">CID</label>'+
          '    <input type="text" id="aid" class="form-control" placeholder="AID" required="" autofocus="" value = "'+x.aid+'">'+
          '    <label for="inputPassword" class="sr-only">Password</label>'+
          '    <input type="password" id="pwd" class="form-control" placeholder="Password" required="">'+
          '    <div class="checkbox mb-3">'+
          '      <label>'+
          '       <a id="a_go_join" href="#">AID</a>'+
          '      </label>'+
          '    </div>'+
          '    <div id="btn_mypage"></div>'+
          '    <p class="mt-5 mb-3 text-muted">© 2017-2019</p>'+
          '  </form>'+
          '</body>'
    }
